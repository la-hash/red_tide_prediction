...
# from metrics import f1_score #包待定
from sklearn.metrics import f1_score
from torch.autograd import Variable
from tqdm import tqdm
from data_to_graph import creat_graph, combination,create_data,future_data_every_list
...
class Predictor(object):
    ...
    def train(self):
        self.model = LSTMs(self.params['input_dim'], self.params['hidden_dim'], self.params['out_dim'],
                           self.params['layers'],
                           self.params['dropout'])
...
if __name__ == '__main__':
    ...
    X, Y = create_data(future_data_selected,1600)
    params = {'input_dim': 12, 'hidden_dim': 16, 'out_dim': 3, 'layers': 2,
